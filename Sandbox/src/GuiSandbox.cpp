...
void GuiSandbox::onAttach() {

}

void GuiSandbox::onDetach() {

}

void GuiSandbox::onUpdate(Salad::Timestep ts) {
...
void GuiSandbox::onEvent(Salad::Event& e) {
	Salad::EventDispatcher dispatcher(e);
	dispatcher.dispatch<Salad::WindowResizeEvent>(SLD_BIND_EVENT_FN(GuiSandbox::onWindowResizedEvent));
	m_GuiWindow->onEvent(e);
}

bool GuiSandbox::onWindowResizedEvent(Salad::WindowResizeEvent& e) {
